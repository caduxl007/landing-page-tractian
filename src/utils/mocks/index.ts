export { benefits_product } from './benefits-product';
...
export { details_safe } from './details-safe';
export { feedbacks_users } from './feedbacks-users';
export { link_image_investors } from './link-image-investors';
export { link_image_recognition } from './link-image-recognition';
